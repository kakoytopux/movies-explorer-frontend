  ...
  return (
    ...
    <main className="content">
      <section className="profile">
        ...
        <form method="post" className="profile__form" name="edit">
          ...
          <div className="profile__box">
            <button type="button" className={`profile__btn ${disabled ? '' : 'profile__btn_active'}`} onClick={editProfile}>Редактировать</button>
            {disabled &&
